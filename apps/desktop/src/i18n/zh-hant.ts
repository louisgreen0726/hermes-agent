...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    quickEntry: {
      ...
      inputLabel: '快速輸入',
      promptPlaceholder: '詢問 Hermes…',
      disconnectedPlaceholder: '尚未連線。請開啟 Hermes 以重新連線。',
      sendTo: '傳送至',
      targetLabel: '目標對話',
      currentChat: '目前聊天',
      newSession: '新對話'
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        '遠端主機上未安裝 Hermes。請在遠端安裝 Louis 發行版（curl -fsSL https://raw.githubusercontent.com/louisgreen0726/hermes-agent/main/scripts/install.sh | bash）或設定 Hermes 路徑。',
