...
export const ja = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        'リモートホストに Hermes がインストールされていません。Louis ディストリビューションをインストールする（curl -fsSL https://raw.githubusercontent.com/louisgreen0726/hermes-agent/main/scripts/install.sh | bash）か、Hermes パスを設定してください。',
      sshErrPlatform:
